...
function send() {
    ...
    var filter = {
        ...
        sort_level1: ($("#s-level1").css("visibility") != "hidden") ? $("#sort-level1 option:selected").val() : "",
        mode_level1: $("#mode-level1 option:selected").val(),
        sort_level2: ($("#s-level2").css("visibility") != "hidden") ? $("#sort-level2 option:selected").val() : "",
        mode_level2: $("#mode-level2 option:selected").val(),
        sort_level3: ($("#s-level3").css("visibility") != "hidden") ? $("#sort-level3 option:selected").val() : "",
