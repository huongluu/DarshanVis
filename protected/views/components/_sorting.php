<div class="row" id="s-level1">
    ...
    <div class="col-md-4 form-group">
        <div class="input-group">
            ...
            <select name="sort-level1" id="sort-level1" class="form-control selectpicker sortpicker">
            </select>
        </div>
    </div>
...
<div class="row" id="s-level2">
    ...
    <div class="col-md-4 form-group">
        <div class="input-group">
            ...
            <!--<span class = "input-group-addon" style = "background-color: white;">Sort</span>-->
            <select name="sort-level2" id="sort-level2" class="form-control selectpicker sortpicker">
            </select>
        </div>
    </div>
...
<div class="row" id="s-level3">
    ...
    <div class="col-md-4 form-group">
        <div class="input-group">
            ...
            <!--<span class = "input-group-addon" style = "background-color: white;">Sort</span>-->
            <select name="sort-level3" id="sort-level3" class="form-control selectpicker sortpicker">
            </select>
        </div>
    </div>
